...
const BicycleCreate = () => {
    ...
    const [frontGroupset, setFrontGroupset] = useState('');
    const [backGroupset, setBackGroupset] = useState('');
    const [brakes, setBrakes] = useState('');
    const [userId, setUserId] = useState(userInfo.id);
    const [materialId, setMaterialId] = useState('');
    const [typeId, setTypeId] = useState('');
    const [brakesTypeId, setBrakesTypeId] = useState('');
    const [publicBike, setPublicBike] = useState(2);
    //Error variables
    ...
    const handleSubmit = async () => {
        ...
        setLoading(true);
        const response = await createBicycle(body);
